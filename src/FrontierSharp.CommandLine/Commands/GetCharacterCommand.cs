...
public class GetCharacterCommand(ILogger<GetCharacterCommand> logger, IFrontierDevToolsClient devToolsClient, IAnsiConsole ansiConsole) : AsyncCommand<GetCharacterCommand.Settings> {
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings) {
        var result = settings.SearchType switch {
            ...
            CharacterSearchType.Address => await devToolsClient.GetCharactersByAddress(settings.Address, CancellationToken.None),
        ...
        public CharacterSearchType SearchType {
            get {
                if (!string.IsNullOrWhiteSpace(Name)) {
                    return CharacterSearchType.Name;
                }

                if (!string.IsNullOrWhiteSpace(Address)) {
                    return CharacterSearchType.Address;
                }
