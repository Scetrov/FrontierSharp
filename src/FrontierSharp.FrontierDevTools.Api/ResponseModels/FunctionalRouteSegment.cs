...
public class FunctionalRouteSegment {
    [JsonPropertyName("deploy_from")]
    public required string DeployFrom { get; set; }

    [JsonPropertyName("deploy_to")]
    public required string DeployTo { get; set; }
    ...
    [JsonPropertyName("ship_path")]
    public required IEnumerable<ShipPathSegment> ShipPath { get; set; }
}