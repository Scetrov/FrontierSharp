...
public class SmartAssembly {
    ...
    [JsonPropertyName("owner")] public SmartCharacter Owner { get; set; } = new();

    [JsonPropertyName("energyUsage")] public ulong EnergyUsage { get; set; } = 0;

    [JsonPropertyName("typeId")] public int TypeId { get; set; } = 0;
}