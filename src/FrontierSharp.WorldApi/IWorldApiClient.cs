...
public interface IWorldApiClient {
    ...
    Task<Result<WorldApiPayload<GameType>>> GetFuelsPage(long limit = 100, long offset = 0, CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<GameType>>> GetAllFuels(long limit = 100, CancellationToken cancellationToken = default);
}